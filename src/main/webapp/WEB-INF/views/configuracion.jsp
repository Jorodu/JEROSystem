			...
			<div class="d-flex">				
                                <div class="col-lg-12 about-right slider-right-con">
                                    <div style="text-align: left;">                                        
                                        <b style="font-size: 42px;color: #5DADF7;">Lista de valores</b>

                                        <c:if test="${lstDatos.size() == 0}">
                                            No hay productos publicados.
                                        </c:if>     
                                        <div class="header-contact-w3ls text-center mt-lg-0 mt-4" style="text-align: center;">
                                            <a href="<%=request.getContextPath()%>/crearConfiguracion?id=0" class="rounded py-sm-3 py-2 px-5" style="background-color: #5DADF7;">
                                        ...
                                        <table id="tableConsulta" class="table table-striped table-bordered" style="width:100%">
                                            ...
                                            <tbody>
                                                <c:forEach var="dato" items="${lstDatos}">      
                                                    <tr>
                                                        <td>
                                                            <a href="<%=request.getContextPath()%>/crearConfiguracion?id=${dato.id_categoria}">Editar</a>
                                                        </td>
                                                        <td>${dato.descripcion}</td>
                                                        <td>${dato.desc_tipo_categoria}</td>
